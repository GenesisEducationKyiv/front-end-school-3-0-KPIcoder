...
export const getSelectedIds = (selectedIds: Set<string>): string[] => Array.from(selectedIds);

export const isSelected = (selectedIds: Set<string>, id: string): boolean => selectedIds.has(id);
...
export const getSelectedCount = (selectedIds: Set<string>): number => selectedIds.size;
