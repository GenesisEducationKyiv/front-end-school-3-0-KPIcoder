 ...
 */
export function Spinner({ className, size, variant, label = 'Loading...', centered = false, ...props }: SpinnerProps) {
  return (
    <div role="status" className={cn(centered && 'flex justify-center items-center', className)} {...props}>
 ...
 */
export function LoadingSpinner({ size, variant, message, className, ...props }: SpinnerProps & { message?: string }) {
  return (
    <div
